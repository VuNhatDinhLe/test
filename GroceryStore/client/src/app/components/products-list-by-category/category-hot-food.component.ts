...
@Component({
  selector: 'app-category-hot-food',
  templateUrl: './category-hot-food.component.html',
  styleUrls: ['./category-hot-food.component.css']
})
export class HotFoodCategoryComponent implements OnInit {
