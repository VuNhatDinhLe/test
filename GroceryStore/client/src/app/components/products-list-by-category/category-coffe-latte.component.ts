...
@Component({
  selector: 'app-category-coffe-latte',
  templateUrl: './category-coffe-latte.component.html',
  styleUrls: ['./category-coffe-latte.component.css']
})
export class CoffeLatteCategoryComponent implements OnInit {
